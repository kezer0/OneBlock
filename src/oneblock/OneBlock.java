...
import oneblock.network.OneBlockDatabase;
...
public class OneBlock extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Datafile();
        OneBlockDatabase.initialize(this);
    ...
    public Location getLeave() {
        return new Location(leavewor, config.getDouble("xleave"), config.getDouble("yleave"), config.getDouble("zleave"), (float) config.getDouble("yawleave"), 0f);
    }
